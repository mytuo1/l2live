...
// Tutorial close
	...
	private static void checkClassMaster(QuestState st)
	{
		...
		if (canChangeClass(player, jobLevel))
		{
			...
			html.append("<html noscrollbar><head><title>L2Mutiny Newbie Tutorial</title></head>");
			html.append("<body>");
			...
			html.append("<font name=hs12 color=3399FF>L2Mutiny</font>");
			html.append("<img src=\"L2UI.squaregray\" width=285 height=1/>");
			...
			html.append("<tr><td align=center><br><font color=LEVEL name=hs12>Welcome to L2Mutiny ! </font></td></tr>");
			html.append("</table>");
			html.append("<br1>");
