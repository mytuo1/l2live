...
//
////TODO: make interface for all events and load from it
...
//        } else
//            // if not try scheduling from the config
//            scheduleEventStart();
//    }
//
...
//                    addItem(player, rewards[i][0], Math.round((Config.EVENT_CtFrate ? player.getLevel() : 1) * rewards[i][1] * rate), null);
//        if (team2)
...
//                double radian = Math.toRadians(angle - 90); // angle in radians
...
//            if (flag != null && flag.getCustomType1() == 77) // 77 is the event flag
//            {
//                flag.setCustomFlags(0);
//                player.getInventory().destroyItem(flag, 1, null);
...
//            return;
//
//        // log out or exit during registration
...
//        }
//
//        // log out or exit during teleportation
...
//                               effect.setPeriod(1200000); //20 minutes
