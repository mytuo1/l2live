import { $, tween, isMobile, isFireFox, $wnd, wndW, wndH } from "./_utility";
...
function initParallaxMouse () {
    ...
    parallaxMouseTimeout = setTimeout(() => {
        let $newParallax = $('[data-mouse-parallax-z]:not(.parallaxed)').addClass('parallaxed');
