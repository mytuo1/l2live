import { $, tween, $wnd, $doc, isIOs } from "./_utility";
...
function initSearchBlock () {
    const self = this;
    let $search = $('.nk-search');
    let $searchField = $search.find('.nk-search-field');
    ...
    $wnd.on('nk-open-full-navbar nk-open-cart' + (isIOs ? '' : ' scroll'), () => {
        self.closeSearch();
    });
}
