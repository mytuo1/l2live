...
public class FakePlayersEngine
{
	...
	public static FakePlayer getNewFakePlayer()
	{
		try (Connection con = DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement("SELECT account_name, obj_Id, clanid FROM characters WHERE accesslevel > 1 AND accesslevel < 100 ORDER BY pvpkills DESC");
