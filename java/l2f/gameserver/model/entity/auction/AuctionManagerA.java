...
public class AuctionManagerA
{
	private static AuctionManagerA _instance;
	private static final Logger _log = LoggerFactory.getLogger(AuctionManagerA.class);
	...
	public static AuctionManagerA getInstance()
	{
		if (_instance == null)
			_instance = new AuctionManagerA();
		return _instance;
	}
}
