...
public final class QuestState
{
	 ...
	 * <br><br>
	 * РњРµС‚РѕРґ СѓС‡РёС‚С‹РІР°РµС‚ СЂРµР№С‚С‹!
	 * 3-РёР№ РїР°СЂР°РјРµС‚СЂ true/false РїРѕРєР°Р·С‹РІР°РµС‚ СЏРІР»СЏРµС‚СЃСЏ Р»Рё РєРІРµСЃС‚ РЅР° РїСЂРѕС„РµСЃСЃРёСЋ
	 * Рё СЂРµР№С‚С‹ СѓС‡РёС‚С‹РІР°СЋС‚СЃСЏ РІ Р·Р°РІРёРјРёСЃРѕРјС‚Рё РѕС‚ РїР°СЂР°РјРµС‚СЂР° RateQuestsRewardOccupationChange
	 */
	...
	/**
	 * Р�СЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РґР»СЏ РѕРґРЅРѕРґРЅРµРІРЅС‹С… РєРІРµСЃС‚РѕРІ
	 */
	...
	public QuestState exitCurrentQuest(boolean repeatable)
	{
		...
		{ // Otherwise, delete variables for quest and update database (quest CANNOT be created again => not repeatable)
			...
			Quest.updateQuestInDb(this); // FIXME: РѕРЅРѕ РІСЂРѕРґРµ РЅРµ РЅСѓР¶РЅРѕ?
		}
	...
	/**
	 * <font color=red>РќРµ РёСЃРїРѕР»СЊР·РѕРІР°С‚СЊ РґР»СЏ РїРѕР»СѓС‡РµРЅРёСЏ РєРѕРЅРґРѕРІ!</font><br><br>
	 * <p/>
	...
	/**
	 * Р’РѕР·РІСЂР°С‰Р°РµС‚ РїРµСЂРµРјРµРЅРЅСѓСЋ РІ РІРёРґРµ С†РµР»РѕРіРѕ С‡РёСЃР»Р°.
	 *
	 ...
	 * @param itemId
	 * @param count
	 * @param rate   - СѓС‡РµС‚ РєРІРµСЃС‚РѕРІС‹С… СЂРµР№С‚РѕРІ
	 */
	...
	/**
	 * Р­С‚РѕС‚ РјРµС‚РѕРґ СЂР°СЃСЃС‡РёС‚С‹РІР°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ РґСЂРѕРїРЅСѓС‚С‹С… РІРµС‰РµР№ РІ Р·Р°РІРёСЃРёРјРѕСЃС‚Рё РѕС‚ СЂРµР№С‚РѕРІ.
	 * <br><br>
	 * РЎР»РµРґСѓРµС‚ СѓС‡РµСЃС‚СЊ, С‡С‚Рѕ РєРѕРЅС‚СЂРѕР»СЊ Р·Р° РІРµСЂС…РЅРёРј РїСЂРµРґРµР»РѕРј РІРµС‰РµР№ РІ РєРІРµСЃС‚Р°С…, РІ РєРѕС‚РѕСЂС‹С…
	 * РЅСѓР¶РЅРѕ РЅР°Р±РёС‚СЊ РѕРїСЂРµРґРµР»РµРЅРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРµРґРјРµС‚РѕРІ РЅРµ РѕСЃСѓС‰РµСЃС‚РІР»СЏРµС‚СЃСЏ.
	 * <br><br>
	 * РќРё РѕРґРёРЅ РёР· РїРµСЂРµРґР°РІР°РµРјС‹С… РїР°СЂР°РјРµС‚СЂРѕРІ РЅРµ РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ СЂР°РІРµРЅ 0
	 *
	 * @param count	  РєРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРё СЂРµР№С‚Р°С… 1С…
	 * @param calcChance С€Р°РЅСЃ РїСЂРё СЂРµР№С‚Р°С… 1С…, РІ РїСЂРѕС†РµРЅС‚Р°С…
	 * @return РєРѕР»РёС‡РµСЃС‚РІРѕ РІРµС‰РµР№ РґР»СЏ РґСЂРѕРїР°, РјРѕР¶РµС‚ Р±С‹С‚СЊ 0
	 */
	 ...
	 * РќРё РѕРґРёРЅ РёР· РїРµСЂРµРґР°РІР°РµРјС‹С… РїР°СЂР°РјРµС‚СЂРѕРІ РЅРµ РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ СЂР°РІРµРЅ 0
	 *
	 * @param min		РјРёРЅРёРјР°Р»СЊРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРё СЂРµР№С‚Р°С… 1С…
	 * @param max		РјР°РєСЃРёРјР°Р»СЊРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРё СЂРµР№С‚Р°С… 1С…
	 * @param calcChance С€Р°РЅСЃ РїСЂРё СЂРµР№С‚Р°С… 1С…, РІ РїСЂРѕС†РµРЅС‚Р°С…
	 * @return РєРѕР»РёС‡РµСЃС‚РІРѕ РІРµС‰РµР№ РґР»СЏ РґСЂРѕРїР°, РјРѕР¶РµС‚ Р±С‹С‚СЊ 0
	 */
	...
	/**
	 * Р­С‚РѕС‚ РјРµС‚РѕРґ СЂР°СЃСЃС‡РёС‚С‹РІР°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ РґСЂРѕРїРЅСѓС‚С‹С… РІРµС‰РµР№ РІ Р·Р°РІРёСЃРёРјРѕСЃС‚Рё РѕС‚ СЂРµР№С‚РѕРІ Рё РґР°РµС‚ РёС…,
	 * РїСЂРѕРІРµСЂСЏРµС‚ РјР°РєСЃРёРјСѓРј, Р° С‚Р°Рє Р¶Рµ РїСЂРѕРёРіСЂС‹РІР°РµС‚ Р·РІСѓРє РїРѕР»СѓС‡РµРЅРёСЏ РІРµС‰Рё.
	 * <br><br>
	 * РќРё РѕРґРёРЅ РёР· РїРµСЂРµРґР°РІР°РµРјС‹С… РїР°СЂР°РјРµС‚СЂРѕРІ РЅРµ РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ СЂР°РІРµРЅ 0
	 *
	 * @param itemId	 id РІРµС‰Рё
	 * @param min		РјРёРЅРёРјР°Р»СЊРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРё СЂРµР№С‚Р°С… 1С…
	 * @param max		РјР°РєСЃРёРјР°Р»СЊРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРё СЂРµР№С‚Р°С… 1С…
	 * @param limit	  РјР°РєСЃРёРјСѓРј С‚Р°РєРёС… РІРµС‰РµР№
	 * @param calcChance
	 * @return true РµСЃР»Рё РїРѕСЃР»Рµ РІС‹РїРѕР»РЅРµРЅРёСЏ РєРѕР»РёС‡РµСЃС‚РІРѕ РґРѕСЃС‚РёРіР»Рѕ Р»РёРјРёС‚Р°
	 */
	...
	/**
	 * Р­С‚РѕС‚ РјРµС‚РѕРґ СЂР°СЃСЃС‡РёС‚С‹РІР°РµС‚ РєРѕР»РёС‡РµСЃС‚РІРѕ РґСЂРѕРїРЅСѓС‚С‹С… РІРµС‰РµР№ РІ Р·Р°РІРёСЃРёРјРѕСЃС‚Рё РѕС‚ СЂРµР№С‚РѕРІ Рё РґР°РµС‚ РёС…,
	 * Р° С‚Р°Рє Р¶Рµ РїСЂРѕРёРіСЂС‹РІР°РµС‚ Р·РІСѓРє РїРѕР»СѓС‡РµРЅРёСЏ РІРµС‰Рё.
	 * <br><br>
	 * РЎР»РµРґСѓРµС‚ СѓС‡РµСЃС‚СЊ, С‡С‚Рѕ РєРѕРЅС‚СЂРѕР»СЊ Р·Р° РІРµСЂС…РЅРёРј РїСЂРµРґРµР»РѕРј РІРµС‰РµР№ РІ РєРІРµСЃС‚Р°С…, РІ РєРѕС‚РѕСЂС‹С…
	 * РЅСѓР¶РЅРѕ РЅР°Р±РёС‚СЊ РѕРїСЂРµРґРµР»РµРЅРЅРѕРµ РєРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРµРґРјРµС‚РѕРІ РЅРµ РѕСЃСѓС‰РµСЃС‚РІР»СЏРµС‚СЃСЏ.
	 * <br><br>
	...
	/**
	 * <font color=red>Р�СЃРїРѕР»СЊР·РѕРІР°С‚СЊ РѕСЃС‚РѕСЂРѕР¶РЅРѕ! РЎР»СѓР¶РµР±РЅР°СЏ С„СѓРЅРєС†РёСЏ!</font><br><br>
	 * <p/>
	 * РЈСЃС‚Р°РЅР°РІР»РёРІР°РµС‚ РїРµСЂРµРјРµРЅРЅСѓСЋ Рё СЃРѕС…СЂР°РЅСЏРµС‚ РІ Р±Р°Р·Сѓ, РµСЃР»Рё СѓСЃС‚Р°РЅРѕРІР»РµРЅ С„Р»Р°Рі. Р•СЃР»Рё РїРѕР»СѓС‡РµРЅ cond РѕР±РЅРѕРІР»СЏРµС‚ СЃРїРёСЃРѕРє РєРІРµСЃС‚РѕРІ РёРіСЂРѕРєР° (С‚РѕР»СЊРєРѕ СЃ С„Р»Р°РіРѕРј).
	 *
	 * @param var   : String pointing out the name of the variable for quest
	 * @param val   : String pointing out the value of the variable for quest
	 * @param store : РЎРѕС…СЂР°РЅСЏРµС‚ РІ Р±Р°Р·Сѓ Рё РµСЃР»Рё var СЌС‚Рѕ cond РѕР±РЅРѕРІР»СЏРµС‚ СЃРїРёСЃРѕРє РєРІРµСЃС‚РѕРІ РёРіСЂРѕРєР°.
	...
	/**
	 * РЈРґР°Р»СЏРµС‚ СѓРєР°Р·Р°РЅРЅС‹Рµ РїСЂРµРґРјРµС‚С‹ РёР· РёРЅРІРµРЅС‚Р°СЂСЏ РёРіСЂРѕРєР°, Рё РѕР±РЅРѕРІР»СЏРµС‚ РёРЅРІРµРЅС‚Р°СЂСЊ
	 *
	 * @param itemId : id СѓРґР°Р»СЏРµРјРѕРіРѕ РїСЂРµРґРјРµС‚Р°
	 * @param count  : С‡РёСЃР»Рѕ СѓРґР°Р»СЏРµРјС‹С… РїСЂРµРґРјРµС‚РѕРІ<br>
	 *               Р•СЃР»Рё count РїРµСЂРµРґР°С‚СЊ -1, С‚Рѕ Р±СѓРґСѓС‚ СѓРґР°Р»РµРЅС‹ РІСЃРµ СѓРєР°Р·Р°РЅРЅС‹Рµ РїСЂРµРґРјРµС‚С‹.
	 * @return РљРѕР»РёС‡РµСЃС‚РІРѕ СѓРґР°Р»РµРЅРЅС‹С… РїСЂРµРґРјРµС‚РѕРІ
	 */
	...
	public String setCond(int newCond, boolean store)
	{
		...
		{
			// СѓР¶Рµ РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РІС‚РѕСЂРѕР№ С„РѕСЂРјР°С‚
			if (newCond > 2) // Р•СЃР»Рё СЌС‚Р°Рї РјРµРЅСЊС€Рµ 3 С‚Рѕ РІРѕР·РІСЂР°С‰Р°РµРјСЃСЏ Рє РїРµСЂРІРѕРјСѓ РІР°СЂРёР°РЅС‚Сѓ.
			{
		...
		{
			// Р’С‚РѕСЂРѕР№ РІР°СЂРёР°РЅС‚ С‚РµРїРµСЂСЊ РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РІСЃРµРіРґР° РµСЃР»Рё СЌС‚Р°Рї Р±РѕР»СЊС€Рµ 2
			if (newCond > 2)
	...
	/**
	 * РЈСЃС‚Р°РЅР°РІР»РµРІР°РµС‚ РІСЂРµРјСЏ, РєРѕРіРґР° РєРІРµСЃС‚ Р±СѓРґРµС‚ РґРѕСЃС‚СѓРїРµРЅ РїРµСЂСЃРѕРЅР°Р¶Сѓ.
	 * РњРµС‚РѕРґ РёСЃРїРѕР»СЊР·СѓРµС‚СЃСЏ РґР»СЏ РєРІРµСЃС‚РѕРІ, РєРѕС‚РѕСЂС‹Рµ РїСЂРѕС…РѕРґСЏС‚СЃСЏ РѕРґРёРЅ СЂР°Р· РІ РґРµРЅСЊ.
	 */
