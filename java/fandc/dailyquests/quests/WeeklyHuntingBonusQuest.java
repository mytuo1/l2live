 ...
 * @author Mutiny
 */
public class WeeklyHuntingBonusQuest extends AbstractDailyQuest
{
	public WeeklyHuntingBonusQuest()
	{
		CharListenerList.addGlobal(new EnterWorldList());
		CharListenerList.addGlobal(new WeeklyHuntingComplete());
	}
	...
	private class EnterWorldList implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
				...
				{
					AbstractDailyQuest quest = WeeklyHuntingBonusQuest.this;
	...
	private class WeeklyHuntingComplete implements OnWeeklyHuntDQCompletedListener
	{
		@Override
		public void onWeeklyHuntDQCompleted(Player player)
		{
			AbstractDailyQuest bonusdq = WeeklyHuntingBonusQuest.this;
