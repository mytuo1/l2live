 ...
 * @author Mutiny
 */
public class TimeBonusQuest extends AbstractDailyQuest
{
	public TimeBonusQuest()
	{
		CharListenerList.addGlobal(new EnterWorldList());
		CharListenerList.addGlobal(new TimeComplete());
	}
	...
	private class EnterWorldList implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
				...
				{
					AbstractDailyQuest quest = TimeBonusQuest.this;
	...
	private class TimeComplete implements OnTimeDQCompletedListener
	{
		@Override
		public void onTimeDQCompleted(Player player)
		{
			AbstractDailyQuest bonusdq = TimeBonusQuest.this;
