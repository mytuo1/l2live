 ...
 * @author Mutiny
 */
public class GeneralBonusQuest extends AbstractDailyQuest
{
	public GeneralBonusQuest()
	{
		CharListenerList.addGlobal(new EnterWorldList());
		CharListenerList.addGlobal(new GeneralComplete());
	}
	...
	private class EnterWorldList implements OnPlayerEnterListener
	{
		...
		public void onPlayerEnter(Player player)
		{
				...
				{
					AbstractDailyQuest quest = GeneralBonusQuest.this;
	...
	private class GeneralComplete implements OnGeneralDQCompletedListener
	{
		@Override
		public void onGeneralDQCompleted(Player player)
		{
			AbstractDailyQuest bonusdq = GeneralBonusQuest.this;
